...
<!-- ![<p><em>A regular 3-layer Neural Network.</em></p>](../assets/nn.jpeg) -->

```{figure} ../assets/nn.jpeg
:name: fig-nn
...
<!-- ![<p><em>A CNN arranges its neurons in three dimensions (width, height, depth), as visualized in one of the layers. Every layer of a CNN transforms the 3D input volume to a 3D output volume of neuron activations. In this example, the red input layer holds the image, so its width and height would be the dimensions of the image, and the depth would be 3 (Red, Green, Blue channels).</em></p>](../assets/cnn.jpeg) -->

```{figure} ../assets/cnn.jpeg
:name: fig-cnn
