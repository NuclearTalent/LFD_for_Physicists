...
See {ref}`demo:svd` for a brief introduction to singular value decomposition. We won't have time to look at everything (or prove everything) in detail, so we will start with the highlights and fill in what we can.
