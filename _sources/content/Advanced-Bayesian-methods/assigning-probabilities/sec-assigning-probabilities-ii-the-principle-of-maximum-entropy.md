...
<!-- ![<p><em>Four different variational functions $f\left( \{ p_i \} \right)$. The optimal $x$ for each one is shown by a circle. The uncorrelated assignment $x=0.07$ is shown by a vertical line.</em></p>](../assets/scandinavian_entropy.png) -->

```{figure} ../assets/scandinavian_entropy.png
