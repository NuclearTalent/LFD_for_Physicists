...
* In {ref}`demo:sum-of-normal-variables-squared` we identify the origin of the $\chi^2$ distribution function from the sum of squares of Gaussian random variables. 