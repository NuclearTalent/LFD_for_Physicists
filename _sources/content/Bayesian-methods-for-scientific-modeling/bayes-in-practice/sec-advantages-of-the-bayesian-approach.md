...
```{figure} ../assets/Leprechaun_or_Clurichaun.png
:height: 250px
:name: fig-Leprechaun
...
```{figure} ../assets/fitting_polynomials.png
:name: fig-fit_poly
:width: 750px
:align: center
...
```{figure} ../assets/fig-model_mixed_eos.png
...
```{figure} ../assets/experimental_design_model.png
