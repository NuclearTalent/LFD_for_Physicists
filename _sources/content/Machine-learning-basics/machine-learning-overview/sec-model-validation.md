...
```{figure} ../assets/over_under_fitting.png
...
```{figure} ../assets/bias_variance_100resamples.png
...
```{figure} ../assets/bias_variance_means.png
...
```{figure} ../assets/learning-curve-epochs.png
